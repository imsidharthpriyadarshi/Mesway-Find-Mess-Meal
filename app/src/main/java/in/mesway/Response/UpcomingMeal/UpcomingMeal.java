...
import in.mesway.Response.Location.MessSubscriptionType;

public class UpcomingMeal {
   ...
   /* @SerializedName("user_info")
    ...
    @Expose
    private MessBasicInfo messInfo;
   /* @SerializedName("subscription_type")
    @Expose
    private MessSubscriptionType subscriptionType;
*/
...
*/
    public MessBasicInfo getMessInfo() {
        return messInfo;
    }

    public void setMessInfo(MessBasicInfo messInfo) {
        this.messInfo = messInfo;
    }

    /*public MessSubscriptionType getSubscriptionType() {
        return subscriptionType;
    }

    public void setSubscriptionType(MessSubscriptionType subscriptionType) {
    ...
    public String toString() {
        ...
        sb.append(UpcomingMeal.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
