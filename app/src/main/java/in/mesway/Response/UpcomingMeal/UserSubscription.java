...
public class UserSubscription {
  ...
  /*  public Boolean getPayment_done() {
    ...
    private MessBasicInfo mess_info;
    ...
    public void setMess_basic_info(MessBasicInfo mess_info) {
    ...
    public String toString() {
        ...
        sb.append(UserSubscription.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
