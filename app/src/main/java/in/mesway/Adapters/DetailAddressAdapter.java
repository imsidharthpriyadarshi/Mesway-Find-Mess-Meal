...
public class DetailAddressAdapter extends RecyclerView.Adapter<DetailAddressAdapter.Viewholder> {
    ...
    public DetailAddressAdapter(List<AddressesModel> addressesModelList, Context context, AddressInterface addressInterface) {
        this.addressesModelList = addressesModelList;
        this.context= context;
        DetailAddressAdapter.addressInterface = addressInterface;
    }

    @NonNull
    @Override
    public DetailAddressAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.model_detail_address,parent,false);
        Viewholder viewholder = new Viewholder(view,context);
        return viewholder ;
    }

    @Override
    public void onBindViewHolder(@NonNull DetailAddressAdapter.Viewholder holder, int position) {
        AddressesModel currentAddress= addressesModelList.get(position);
        addressInterface.getAllBtnView(holder.btn_deliver_here,holder.btn_edit,currentAddress.getLocation_id(),currentAddress.getUser_id());
    ...
    public static class Viewholder extends RecyclerView.ViewHolder {
        ...
        private final MaterialButton btn_edit,btn_deliver_here;
        ...
        public Viewholder(@NonNull View itemView,Context context) {
            ...
            btn_deliver_here= itemView.findViewById(R.id.main_btn);
            mContext=context;
