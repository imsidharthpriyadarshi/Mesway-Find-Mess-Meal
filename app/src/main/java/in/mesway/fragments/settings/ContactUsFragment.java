...
import in.mesway.databinding.FragmentContactUsBinding;
...
public class ContactUsFragment extends Fragment {
    ...
    private void contactUsOperation() {

        contactUsBinding.tCallUsValue.setText(extra_info_response.getContact_no());
        contactUsBinding.tEmailUsValue.setText(extra_info_response.getContact_email());
    ...
    private void clickHandel() {
        contactUsBinding.consCallUs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (contactUsBinding.tCallUsValue.getText()!=null) {
                    Intent call_us = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + contactUsBinding.tCallUsValue.getText()));
                    startActivity(call_us);
                }
            }
        });

        contactUsBinding.consEmailUs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (contactUsBinding.tEmailUsValue.getText()!=null) {
                    Intent mail_us = new Intent(Intent.ACTION_SENDTO, Uri.parse("mailto:" + contactUsBinding.tEmailUsValue.getText()));
                    startActivity(mail_us);
                }
            }
        });

        contactUsBinding.imgBackArrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try {
